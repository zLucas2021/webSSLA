        ...
        <div className="w-[1100px] flex flex-row flex-wrap items-end justify-start gap-[60px] max-w-full mq1100:gap-[30px]">
          <div className="flex-1 flex flex-col items-start justify-start gap-[42px] min-w-[338px] max-w-full mq450:min-w-full mq750:gap-[21px_42px]">
            ...
            <Article
              ...
              subtitle="We follow agile methodologies for efficient project delivery."
            />
            <Article
              title="Cutting-Edge Technologies"
              subtitle="Utilizing the latest technologies to create innovative solutions."
            />
          </div>
          <div className="flex-1 flex flex-col items-start justify-end pt-0 px-0 pb-6 box-border min-w-[338px] max-w-full mq450:min-w-full">
            <div className="self-stretch h-[376px] relative rounded-md bg-gainsboro" />
          </div>
        </div>
      </section>
      <img
